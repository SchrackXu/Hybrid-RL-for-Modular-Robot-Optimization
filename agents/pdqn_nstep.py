...
class QActorNonDueling(nn.Module):
    ...
    def __init__(self, state_size, action_size, action_parameter_size, hidden_layers=None, output_layer_init_std=None,
                 ...
                 squashing_function=False, action_input_layer=0, init_type="kaiming", init_std=None):
...
class PDQNNStepAgent(PDQNAgent):
    ...
    def _optimize_td_loss(self):
        ...
        assert (self.weighted ^ self.average ^ self.random_weighted) \
               or not (self.weighted or self.average or self.random_weighted)
