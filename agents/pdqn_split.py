...
class SplitQActor(nn.Module):
    ...
    def __init__(self, state_size, action_size, action_parameter_size_list, hidden_layers=(64, 32),
                 action_input_layer=0, output_layer_init_std=None,
                 activation="relu", init_type="kaiming", init_std=None):
        ...
        for k in range(self.action_size):
            self.split_networks.append(QNetwork(lastSharedLayerSize, 1, action_parameter_size_list[k],
                                                hidden_layers=split_layer_sizes,
                                                output_layer_init_std=output_layer_init_std,
